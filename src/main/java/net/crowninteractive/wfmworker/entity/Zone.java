 ...
 */
@Entity
@Table(name = "zone", catalog = "wfm_new", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Zone.findByToken", query = "SELECT z FROM Zone z WHERE z.token = :token"),
    @NamedQuery(name = "Zone.findByOwnerId", query = "SELECT z FROM Zone z WHERE z.ownerId = :ownerId"),
    ...
    @NamedQuery(name = "Zone.findByCreateTime", query = "SELECT z FROM Zone z WHERE z.createTime = :createTime"),
    @NamedQuery(name = "Zone.findByIsActive", query = "SELECT z FROM Zone z WHERE z.isActive = :isActive"),
    @NamedQuery(name = "Zone.findByUpdateTime", query = "SELECT z FROM Zone z WHERE z.updateTime = :updateTime")})
