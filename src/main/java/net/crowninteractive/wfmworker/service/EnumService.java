        ...
        try {
            ...
            if (err.isEmpty()) {
                ...
                String sql = "SELECT wt.id as id, "
                    ...
                    + "wt.business_unit as business_unit, wt.priority as priority, wt.create_time as create_time,  wt.current_status as current_status, "
                    + "wt.reported_by as reported_by, wt.token as token, wt.address_line_1 as address_line_1, wt.city as city, e.is_migrated as is_migrated "
                    + "FROM `work_order` wt join enumeration_work_order e on wt.ticket_id = e.work_order_id where wt.business_unit like business_unit "
