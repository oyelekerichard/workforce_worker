        ...
        List<Object[][]>list = getEntityManager().
          ...
          for(Object[] e : list){
             ...
             m.setContactNumber((String)e[7]);m.setReferenceType((String)e[8]);m.setReferenceTypeData((String)e[9]);
              ...
              m.setBusinessUnit((String)e[13]);m.setPriority((String)e[14]); m.setCreateTime((Timestamp)e[15]);
              m.setChannel((String)e[16]);m.setIsActive((Integer)e[17]);m.setCurrentStatus((String)e[18]);
              m.setReportedBy((String)e[19]); m.setCustomerName((String)e[20]);
              m.setDisco((String)e[21]); m.setSubDisco((String)e[22]);  m.setInjectionSubstation((String)e[23]);
              m.setInjectionSubstationName((String)e[24]); m.setPowerTransformer((String)e[25]);m.setPowerTransformerName((String)e[26]);
               m.setFeeder((String)e[27]);    m.setFeederName((String)e[28]);  m.setHtPole((String)e[29]);
                m.setHighTensionPhysicalId((String)e[30]);  m.setDistributionSubstation((String)e[31]);
              m.setDistributionSubstationName((String)e[32]); m.setUpriser((String)e[33]); m.setServicePole((String)e[34]);
            m.setServiceWire((String)e[35]);   m.setNercId((String)e[36]); m.setConnectionType((String)e[37]);
             m.setTransformer((String)e[38]);   m.setCreatedBy((Integer)e[39]);
